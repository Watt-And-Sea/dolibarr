...
class SupplierInvoiceLine extends CommonObjectLine
{
	...
	{
	    $sql = 'SELECT f.rowid, f.ref as ref_supplier, f.label as custom_label, f.description as line_desc, f.date_start, f.date_end, f.pu_ht, f.pu_ttc, f.qty, f.remise_percent, f.tva_tx';
	    ...
	    $sql .= ', f.multicurrency_subprice, f.multicurrency_total_ht, f.multicurrency_total_tva, f.multicurrency_total_ttc';
	    ...
	    $this->label = $obj->custom_label; // Utiliser custom_label au lieu de product_label
	...
	public function update($notrigger = 0)
	{
	    ...
	    $sql .= " label = ".(!empty($this->label) ? "'".$this->db->escape($this->label)."'" : "null").","; // Ajouter le champ label
	...
	public function insert($notrigger = 0, $noerrorifdiscountalreadylinked = 0)
	{
	    ...
	    $sql .= " ".(!empty($this->label) ? "'".$this->db->escape($this->label)."'" : "null").","; // Utiliser directement $this->label
